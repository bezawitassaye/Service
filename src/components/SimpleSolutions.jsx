...
const SimpleSolutions = () => {
    ...
    return (
       <section
  id='company'
  className='relative bg-orange-50 py-16 px-4 sm:px-6 md:px-8 lg:px-20 flex flex-col lg:flex-row justify-center items-center'
>
  {/* Image */}
  <div className='flex-1 flex justify-center max-w-xl' data-aos="fade-right">
    <img
      src={persones}
      alt='People working'
      className='w-4/5 sm:w-3/4 md:w-2/3 lg:w-full max-w-lg object-contain max-h-[400px]'
    />
  </div>
