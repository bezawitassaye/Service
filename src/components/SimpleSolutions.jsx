...
const SimpleSolutions = () => {
    ...
    return (
       <section
  id='services'
  className='relative lg:top-38 bg-orange-50 py-16 px-4 sm:px-6 md:px-8 lg:px-20 flex flex-col lg:flex-row justify-center items-center'
>
  {/* Image */}
 <div className='flex-1 flex justify-center max-w-xl' data-aos="fade-right">
  <img
    src={persones}
    alt='People working'
    className='w-4/5 sm:w-3/4 md:w-2/3 lg:w-full lg:max-w-2xl object-contain lg:max-h-[600px]'
  />
</div>
  ...
  <div className='flex flex-col justify-start items-start space-y-6' data-aos="fade-left">
    ...
    {/* Buttons */}
    <div
      className='flex flex-wrap sm:flex-nowrap items-center justify-center gap-6'
      data-aos="fade-up"
      data-aos-delay="200"
    >
