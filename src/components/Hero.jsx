  ...
  return (
    ...
    md:px-8 lg:py-16  lg:px-30 flex flex-col lg:flex-row items-center justify-between'>
      ...
      <div className='flex-1 lg:ml-28 justify-center w-full max-w-xl space-y-6 relative z-20'>
        <h2 className='text-4xl sm:text-5xl text-gray-900 text-center lg:text-left font-bold text-sty '>
        ...
        <div className='pt-2 flex mt-4 justify-center lg:justify-start'>
        ...
        <div className='pt-2 flex mt-4 justify-center lg:justify-start gap-4 items-center'>
